...
class Card extends React.Component {
    ...
    render() {
        const { className, isMobile, background, title, buttonText, description, primaryAction, secondaryAction, secondButtonText } = this.props;
        return (
            ...
            ${className ? className : ''} `}>
                <div className={`${background} background-card`} />
